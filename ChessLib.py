...
@cython.locals(count=cython.uint, int_type=cython.ulonglong)
...
BB_PAWN_ATTACKS_WHITE = BB_PAWN_ATTACKS[WHITE]
BB_PAWN_ATTACKS_BLACK = BB_PAWN_ATTACKS[BLACK]
...
class Move(object):
    ...
    """
    #cython.declare(from_square=cython.longlong, to_square=cython.longlong, promotion=cython.longlong)
...
class Bitboard(object):
    ...
    #@cython.locals(piece_type=cython.ulonglong, piece_index=cython.ulonglong)
   ...
   # @cython.ccall
   # @cython.locals(square=cython.ulonglong, mask=cython.ulonglong)
    ...
    @cython.locals(square=cython.ulonglong, color=cython.ulonglong)
    ...
    #@cython.ccall
    @cython.locals(square=cython.ulonglong, 
                   color=cython.ulonglong, 
                   attackers=cython.ulonglong)
...
#        return False
    ...
    @cython.locals(zobrist_hash=cython.ulonglong)
